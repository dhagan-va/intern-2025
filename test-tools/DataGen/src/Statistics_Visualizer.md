...
xychart-beta
    ...
    y-axis "Records/Second" 0 --> 4515.084520700928
    bar [3702.1857076558344, 4505.084520700928]
```
...
Total Number of Messages Generated: **59982**
## Throughput
```mermaid
xychart-beta
    title "Throughput (Transactions per Second)"
    x-axis ["270", "837", "277", "835", "834"]
    y-axis "TPS" 0 --> 3664.8641911058658
    bar [1436.999702164311, 2844.08863701668, 3254.2232962934995, 3663.8641911058658, 3035.3404472701823]
```
...
xychart-beta
    ...
    x-axis ["D2", "FK", "R"]
    y-axis "Amount" 0 --> 51110.50832766557
    bar [49892.48235047025, 50110.50832766557, 49979.20834466886]
```
...
xychart-beta
    ...
    x-axis ["C1", "P3", "B9"]
    y-axis "Number of Visits" 0 --> 8.5126025205041
    bar [7.412982596519304, 7.5126025205041005, 7.481796359271854]
```
