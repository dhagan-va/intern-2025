...
class DataAccess(ABC):
    ...
    @abstractmethod
    def save_many_claims(self, claims): pass

    @abstractmethod
    def get_claim_transactions(self, status, date): pass

    @abstractmethod
    def update_claims_status(self, claim_ids, new_status): pass

    @abstractmethod
    def total_claim_transactions(self): pass
